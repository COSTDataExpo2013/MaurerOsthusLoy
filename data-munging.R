...
#09 and 10 need CitySubtypeWord (QS5) converted into a character from a factor
#08 needs it converted from an integer so that they will play nice
...
## KILL ALL HUMANS... *cough*... I mean delete all rows with missing survey weights ##
...
#1 is the best possible score. 0 is the worst possible score.
